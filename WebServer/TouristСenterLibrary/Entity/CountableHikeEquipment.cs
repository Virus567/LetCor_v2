...
namespace TouristСenterLibrary.Entity
{
    public class CountableHikeEquipment
    {
        ...
        public static List<CountableHikeEquipment> GetDefaultEquipment(int peopleAmount, int tentsAmount, int individualSleepingBagAmount)
        {
            ...
            int peopleAmountWithOuthermeticBagAmount = peopleAmount;
            ...
            CountableHikeEquipment hikeSleepingBag = new CountableHikeEquipment(sleepingBag, peopleAmount - individualSleepingBagAmount);
            ...
            CountableHikeEquipment hikeHermeticBag =
                new CountableHikeEquipment(hermeticBag, (peopleAmountWithOuthermeticBagAmount / 2) + 1);
